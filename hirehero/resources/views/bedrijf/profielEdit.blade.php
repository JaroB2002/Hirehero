<x-layouts.bedrijf-layout>
    ...
    <header>
        ...
        <p>Oprichtings datum:<span><input type="date" name="oprichtingsdatum" value="{{$company->oprichtingsdatum ? $company->oprichtingsdatum->format('d-m-Y') : '' }}"></span></p>
        <x-input-error :messages="$errors->get('oprichtingsdatum')" class="mt-2" />
        <p>Aantal werknemers: {{$company->employees}}</p>
        <x-input-error :messages="$errors->get('employees')" class="mt-2" />
        <p>Locatie: <input type="text" name="plaats" placeholder="plaats" value="{{$company->plaats}}"></p>
        <x-input-error :messages="$errors->get('plaats')" class="mt-2" />
        <p>Sector: <span><input type="text" name="sector" placeholder="sector" value="{{$company->sector}}"></span></p>
    ...
    <main>
        ...
        <div class="mt-8">
            ...
            <p><span><input type="text" name="bedrijfVoorstelling" placeholder="Geef ons wat informatie over wat je doet." value="{{$bedrijfsprofiel->bedrijfVoorstelling ?? 'Hier komt een tekstje'}}"></span></p>
            <x-input-error :messages="$errors->get('bedrijfVoorstelling')" class="mt-2" />
            <img src="" alt="HIER KOMT DE FOTO OF VIDEO VAN HET BEDRIJF">
        </div>

        <div class="mt-8">
            <h2 class="text-3xl font-bolder font-epilogue">Wat is uw doel?</h2>
            <p><span><input type="text" name="doel" placeholder="Geef wat info over het doel van je bedrijf." value="{{$bedrijfsprofiel->doel ?? 'Hier komt een tekstje'}}"></span></p>
            <x-input-error :messages="$errors->get('doel')" class="mt-2" />

        </div>

        <div class="mt-8"> 
            <h2 class="text-3xl font-bolder font-epilogue">Contact</h2>
            <p><span><input type="text" name="x" placeholder="Link naar je X account" value=""></span></p>
            <x-input-error :messages="$errors->get('x')" class="mt-2" />
            <p><span><input type="text" name="linkedin" placeholder="Link naar je LinkedIn account" value=""></span></p>
            <x-input-error :messages="$errors->get('linkedin')" class="mt-2" />
            <p><span><input type="text" name="facebook" placeholder="Link naar je facebook account" value=""></span></p>
            <x-input-error :messages="$errors->get('facebook')" class="mt-2" />
            <p><span><input type="text" name="instagram" placeholder="Link naar je instagram account" value=""></span></p>
        ...
        <div class="mt-8">
            ...
            <input type="text" name="skill" placeholder="Voeg een skill toe" value="">
        ...
        <div class="mt-8">
            ...
            <button type="submit">Sla uw wijzigingen op</button>
